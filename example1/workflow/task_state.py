...
DEFAULT_TASKS: tuple[Task, ...] = (
    ...
    Task(5, "ch0.strategic_framing", "战略态势研判", "构思", "DeepSeek v4 Pro", input="1A+2A 检索材料", output="extracted_materials/strategic_framing.md"),
    Task(6, "ch1.1b.write", "1B 顶层设计写作", "写作", "DeepSeek v4 Pro", input="1A 检索结果 + 战略态势卡", output="chapter_drafts/chapter1_top_design.md"),
    Task(7, "ch1.2b.write", "2B 实施机制写作", "写作", "DeepSeek v4 Pro", input="2A 检索结果 + 战略态势卡", output="chapter_drafts/chapter1_implementation.md"),
    Task(8, "ch1.3a.plan", "3A 主题特性定题", "构思", "DeepSeek v4 Pro", input="topic + 战略态势卡", output="extracted_materials/chapter1_topic_specific_title.md"),
    Task(9, "ch1.3b.retrieve", "3B 主题特性检索", "检索", "NotebookLM skill", input="3A 构思产物", output="retrieval_outputs/chapter1_topic_specific.md"),
    Task(10, "ch1.3c.write", "3C 主题特性写作", "写作", "DeepSeek v4 Pro", input="3B 检索结果", output="chapter_drafts/chapter1_topic_specific.md"),
    Task(11, "ch1.assemble", "第一章组装", "编排", "Codex", input="第一章小节草稿", output="chapter_drafts/chapter1.md"),
    Task(12, "ch1.review", "第一章审查", "审查", "DeepSeek v4 Pro", input="chapter1.md + 检索材料", output="review_reports/chapter1_review.md"),
    Task(13, "ch2.topic.plan", "第二章目的层定题", "构思", "DeepSeek v4 Pro", input="topic + 战略态势卡", output="extracted_materials/chapter2_topic.md"),
    Task(14, "ch2.retrieve", "第二章资料铺料", "检索", "NotebookLM skill", input="第二章主题", output="retrieval_outputs/chapter2_materials.md"),
    Task(15, "ch2.dimension.plan", "第二章维度凝练", "构思", "DeepSeek v4 Pro", input="第二章检索结果 + 战略态势卡", output="extracted_materials/chapter2_dimensions.md"),
    Task(16, "ch2.write", "第二章正文写作", "写作", "DeepSeek v4 Pro", input="第二章检索结果 + 维度", output="chapter_drafts/chapter2.md"),
    Task(17, "ch2.review", "第二章审查", "审查", "DeepSeek v4 Pro", input="chapter2.md + 检索材料", output="review_reports/chapter2_review.md"),
    Task(18, "ch3.write", "第三章政策建议写作", "写作", "DeepSeek v4 Pro", input="chapter1.md + chapter2.md + 战略态势卡 + 机构落点", output="chapter_drafts/chapter3.md"),
    Task(19, "final.assemble", "报告组装", "编排", "Codex", input="chapter_drafts/", output="final_report.md"),
    Task(20, "final.review", "最终审查", "审查", "DeepSeek v4 Pro", input="final_report.md + 检索材料", output="review_reports/final_review.md"),
    Task(21, "full.review", "全文内容结构审查", "审查", "DeepSeek v4 Pro", input="final_report.md + 审查意见模板", output="review_reports/fulltext_content_structure_review.md"),
    Task(22, "full.rewrite", "全文内容结构修改", "写作/修改", "DeepSeek v4 Pro", input="final_report.md + 全文审查报告", output="final_report_reviewed.md"),
    Task(23, "run.archive_log", "归档运行日志", "编排", "Codex", input="task_state.md", output="run_log.md"),
)
