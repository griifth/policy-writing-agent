...
> 图纸链（每次接单先读，路径写死）：
> ①元框架：`records/元框架提炼_2026-07-12/元框架.md`
> ②元模块契约：`records/装配式图纸_2026-07-12/元模块契约.md`
> ③调度宪法：`records/装配式图纸_2026-07-12/调度宪法_SKILL草案.md`
> 可调用 skills：report-clarify-v2（触点一）、topic-material-search-v2（侦察/全量）、yongjun-thinking（定题/立论/预读）、cao-thinking（结构/预读）。
